...
package org.onap.mso.adapters.rest;
...
public class RESTClient {
    ...
    /**
     * Sends an http POST request using the specified multipart data.
     *
     * @return api response
     *
     * @throws RESTException if POST was unsuccessful
     */
    public APIResponse httpPost(MultipartEntityBuilder builder) throws RESTException {
        HttpResponse response = null;
        try (CloseableHttpClient httpClient = createClient()) {
            HttpPost httpPost = new HttpPost(this.getURL());
            addInternalHeaders(httpPost);
